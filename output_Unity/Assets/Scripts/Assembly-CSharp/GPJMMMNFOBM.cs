...
public abstract class GPJMMMNFOBM
{
	private class HGJDFJAJLCO : HOPKEMDHFIM.AJOMGAHFFLB
	{
		private GPJMMMNFOBM parent;

		public HGJDFJAJLCO(GPJMMMNFOBM parent)
		{
		}

		void HOPKEMDHFIM.AJOMGAHFFLB.onAdLoaded(string network, double revenue, string msg)
		{
		}

		void HOPKEMDHFIM.AJOMGAHFFLB.onAdFailedToLoad(string msg)
		{
		}

		void HOPKEMDHFIM.AJOMGAHFFLB.onAdShowed(string network, string msg)
		{
		}

		void HOPKEMDHFIM.AJOMGAHFFLB.onAdRewarded(string network, string msg)
		{
		}

		void HOPKEMDHFIM.AJOMGAHFFLB.onAdFailedToShow(string network, int error_code, string msg)
		{
		}

		void HOPKEMDHFIM.AJOMGAHFFLB.onAdClosed(string network)
		{
		}

		void HOPKEMDHFIM.AJOMGAHFFLB.onAdClicked(string network, string msg)
		{
		}

		void HOPKEMDHFIM.AJOMGAHFFLB.onAdInfoChanged(string network, double revenue)
		{
		}
	...
	private Action<string, string> rewardAction;
	...
	public HOPKEMDHFIM.AJOMGAHFFLB radCallback;
	...
	public abstract bool auto_load();
	...
	public void show(Action<string> beforeAction, Action<string, string> showedAction, Action<string, string> rewardAction, Action<string, string> clickAction, Action<bool> closeAction)
	{
	}
